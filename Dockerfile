...
ENV OTEL_AGENT_SERVICE_NAME=paymentservice
...
ENTRYPOINT ./node_modules/.bin/slnodejs run --token $RM_DEV_SL_TOKEN --buildsessionidfile buildSessionId --labid integ_master_813e_SLBoutique -- --require ./tracing.js index.js
