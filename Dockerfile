...
RUN ./node_modules/.bin/slnodejs mocha --token $RM_DEV_SL_TOKEN --buildsessionidfile buildSessionId --teststage "Unit Tests" --useslnode2 -- --recursive test ./test/test.js
